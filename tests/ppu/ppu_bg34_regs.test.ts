...
describe('PPU BG3/BG4 base and scroll registers', () => {
  it('computes BG3/BG4 map/char bases and latches HOFS/VOFS from two writes', () => {
    ...
    // BG34NBA ($210C): high nibble -> BG3 char base, low nibble -> BG4 char base
    // Write 0xB7: BG3 base nibble=0xB -> words=0xB<<11=0x5800; BG4 base nibble=0x7 -> 0x3800
    w8(bus, mmio(0x0c), 0xb7);
    expect(ppu.bg3CharBaseWord).toBe(0x5800);
    expect(ppu.bg4CharBaseWord).toBe(0x3800);
