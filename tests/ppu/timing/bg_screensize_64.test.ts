...
const BG1SC = 0x07; const BG12NBA = 0x0b; const TM = 0x2c; const BG1HOFS = 0x0d;
...
describe('PPU timing: BG1 64× screen width mapping', () => {
  it('reads second screen at +0x400 when tileX>=32 (width64)', () => {
    ...
    // BG1 map base 0x0000, size=01 (64x32)
    ppu.writeReg(BG1SC, 0x01);
    // char base nibble=1 -> 0x0800 words
    ...
    // Tilemap (31,0)=tile1 (end of first screen row), (32,0)=tile2 at +0x400 (start of second screen)
    ...
    ppu.writeReg(BG1HOFS, 0xf8); ppu.writeReg(BG1HOFS, 0x00);
