...
describe('SNES ROM header detection', () => {
    it('detects LoROM mapping with valid checksum/complement', () => {
        ...
        rom[base + 0x1c] = 0x34;
        rom[base + 0x1d] = 0x12; // complement = 0x1234
        rom[base + 0x1e] = 0xcb;
        rom[base + 0x1f] = 0xed; // checksum = 0xedcb, xor -> 0xffff
    ...
    it('prefers HiROM if only HiROM header is valid', () => {
        ...
        const baseHi = 0xffc0;
        rom[baseHi + 0x1c] = 0x78;
        rom[baseHi + 0x1d] = 0x56;
        rom[baseHi + 0x1e] = 0x87;
        rom[baseHi + 0x1f] = 0xa9; // 0x5678 ^ 0xa987 = 0xffff
