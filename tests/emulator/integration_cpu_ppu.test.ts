...
function buildROM() {
  ...
  // LDA #$20
  rom[0x0000] = 0xa9; rom[0x0001] = 0x20;
  // STA $2121 (low byte $21, high $21)
  rom[0x0002] = 0x8d; rom[0x0003] = 0x21; rom[0x0004] = 0x21;
  // LDA #$77
  rom[0x0005] = 0xa9; rom[0x0006] = 0x77;
  // STA $2122
  rom[0x0007] = 0x8d; rom[0x0008] = 0x22; rom[0x0009] = 0x21;
  // BRK (0x00) to end
  rom[0x000a] = 0x00;
  return rom;
}

function makeCartWithResetVector(): { cart: Cartridge, romLoBank: Uint8Array } {
